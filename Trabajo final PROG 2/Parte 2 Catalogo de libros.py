...
books = []          #todos los libros del programa
book = []           #arreglo para almacenar un libro antes de ir mandarlo al arreglo de libros(books)
aidi = []             #arreglo donde se guardan los IDs de los catalogos
catalogo = []     #arreglo para almacenar los catalogos
ID = []                #arreglos para los IDs de los libros
autor = []          #arreglos para guardar los autores de los libros
nombre = []      #arreglos para guardar los nombres de los libros
edicion = []       #arreglos para guardar las ediciones de los libros
isbm = []           #arreglos para guardar los isbm de los libros
fecha = []         #arreglo para guardar las fechas de los libros
ciudad = []        #arreglo para guardar las ciudades de los libros
